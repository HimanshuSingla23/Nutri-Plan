import { IRecipe, IPantryItem, IMealPlan } from "@/types";

export const SAMPLE_RECIPES: Partial<IRecipe>[] = [
  {
...
export const SAMPLE_PANTRY: Partial<IPantryItem>[] = [
  {
    name: "Milk",
    quantity: 1,
    unit: "liter",
    category: "Dairy",
    expirationDate: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000), // Tomorrow (Expiring Soon)
    notes: "Whole milk for breakfast and coffee",
  },
  {
    name: "Eggs",
    quantity: 12,
    ...
    expirationDate: new Date(Date.now() + 6 * 24 * 60 * 60 * 1000), // Fresh
    notes: "Organic farm fresh eggs",
  },
  {
    name: "Tomatoes",
    quantity: 2,
  ...
  },
  {
    ...
    expirationDate: new Date(Date.now() + 180 * 24 * 60 * 60 * 1000), // Long shelf life
    notes: "Aged long-grain basmati",
  },
  {
    name: "Olive Oil",
    quantity: 500,
